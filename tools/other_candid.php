...
<div class="container-fluid my-4">
    <div class="row">
        <div class="col-6 mb-3 text-start">
            <a href="/tools.php" class="btn btn-outline-info"><i class="bi bi-backspace"></i> 返回主页</a>
        </div>
        <?PHP
        ...
        <div class="col-12 d-flex flex-wrap text-center" id="ImageFile">
            ...
            while ($ApiAlbum['data'][$num]['id'] != null) {
                if ($ApiAlbum['data'][$num]['open'] == 1) {
                    ?>
                    <a class="p-1" href="./other_candid_look.php?id=<?php echo $num ?>"><img src="<?php echo $ApiAlbum['data'][$num]['url'] ?>!pw80" style="width: 50px" class="rounded-1"></a>
                    <?php
                } else {
